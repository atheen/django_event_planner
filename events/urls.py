...
from .views import Login, Logout, Signup, home, dashboard, event_details, event_update, events_list, create_event, book_event, update_profile, change_password
...
urlpatterns = [
	...
	path('event/<int:event_id>/book/', book_event, name='book-event'),
